    ...
    >
      ...
      <div className="flex flex-col items-start space-y-7">
        <div className="flex w-[20rem] flex-col items-start justify-center gap-2.5 md:w-100 lg:w-120">
          <label htmlFor="portal" className="inline-flex gap-2 text-left font-medium">
            <ScreenShare className="h-5 w-5" />
            Novo Portal da Advocacia
          </label>

          <a target="_blank" rel="noopener noreferrer" className="inline-flex w-full" href={LINK_PORTAL_ADV} id="portal">
